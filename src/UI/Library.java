...
public class Library
{
	...
	private static Environment createEnvi()
	{
		...
		Environment environment = new Environment(
		        EnvironmentDatabase.getSize() + 1, name, temperature, humidity,
		        light, noise);
	...
	private static Interaction createObj()
	{
		...
		Interaction obj = new Interaction(InteractionDatabase.getSize() + 1,
		        name, type, excited, fearful, relieved, angry);
